...
class TableCountRowsWithCriteriaRefresh extends AbstractCount {

    private def columnHeadersAndCellValuesMap

    def TableCountRowsWithCriteriaRefresh(prefixXPath, antBuilder, descriptionPrefix, columnHeadersAndCellValuesMap) {
    ...
    def doCount(operator, value, description) {
        ...
        antBuilder.countRowsRefresh(xpath: xpath, description: description)
    }
